<?php get_header();?>   <!--  Tells WordPress to include header.php -->
    ...
    <section class="container-fluid about-bg text-center">
        <div class="container">
            ...
            <p class="about-text">
                My  name is josh Whitkin. I’m a professional with more than 7 years of industry experience in Games Design, 
                Level design, Scripting and Visual Effects.  What makes me passionate about games is the combination of technology  and creativity, 
                and how multiple disciplines come together to create an interactive experience. Whether I'm designing for puzzle games, 
                2D platformers or 3D environments. I always tell a story.
            </p>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p class="article-p">
                        STS has never been shy of seeking new terrains of  investigation. More and  more  STS s cholars are  
                        ...
                        new kinds of  knowledge arising from  STS study  of the arts.
                    </p>
